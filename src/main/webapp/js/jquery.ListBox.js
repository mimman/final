		...
		return this.each(function(index){
			...
			var make = {
				...
				make : function(){
					...
					for (var i=0;i < Len;i++){
						if (i!=0){
							html += 	'<li class="jqListBox-option option'+i+'" id="jqListBox-option-'+index+'-'+i+'" data-id="'+i+'" data-val="'+origin_Val[i]+'"role="option" tabindex="0">'+origin_Txt[i]+'</li>';
						} else {
							html += 	'<li class="jqListBox-option selected option'+i+'" id="jqListBox-option-'+index+'-'+i+'" data-id="'+i+'" data-val="'+origin_Val[i]+'" role="option" tabindex="0">'+origin_Txt[i]+'</li>';
						}
					}
					html += 	'</ul>';
					html +=  '</div>';
				...
				change : function(idx){
					...
					el.combo.find('.jqListBox-combo-txt').attr('data-id',idx).text( origin_Txt[idx] ).attr("class", "jqListBox-combo-txt option" + idx   );
