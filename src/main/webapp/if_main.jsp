...
<script src="/Air/js/plugins.js"></script>
<script src="/Air/js/sly.min.js"></script>
<script src="/Air/js/horizontal.js"></script>
<script src="/Air/js/main.js"></script>
</head>
<body>
	...
	<div class="pagespan container">
		...
		<div class="wrap">
			<h2>
				할인 항공권 <span>도시의 화려함과 대자연의 경이로움이 조화를 이루는 곳으로 여행을 함께 떠나보세요!</span>
			</h2>
			...
			<div class="frame" id="cycleitems">
				<ul class="clearfix">
					<li>
						<img src="/Air/img/main/air/air_img01.jpg" alt="" />
						<p><span>북경/만리장성+발마사지 3박4일</span><em>1,500,000원 ~</em></p>
					</li>
					<li>
						<img src="/Air/img/main/air/air_img02.jpg" alt="" />
						<p><span>북경/만리장성+발마사지 3박4일</span><em>1,500,000원 ~</em></p>
					</li>
					<li>
						<img src="/Air/img/main/air/air_img03.jpg" alt="" />
						<p><span>북경/만리장성+발마사지 3박4일</span><em>1,500,000원 ~</em></p>
					</li>
					<li>
						<img src="/Air/img/main/air/air_img01.jpg" alt="" />
		...
		<div class="wrap">
			<h2>
				베스트 여행 상품 <span>도시의 화려함과 대자연의 경이로움이 조화를 이루는 곳으로 여행을 함께 떠나보세요!</span>
			</h2>
			...
			<div class="frame oneperframe" id="oneperframe">
				<ul class="clearfix">
					<li><img src="/Air/img/main/best/best_img01.jpg" alt="" /></li>
					<li><img src="/Air/img/main/best/best_img02.jpg" alt="" /></li>
					<li><img src="/Air/img/main/best/best_img03.jpg" alt="" /></li>
					<li><img src="/Air/img/main/best/best_img04.jpg" alt="" /></li>
					<li><img src="/Air/img/main/best/best_img05.jpg" alt="" /></li>
					<li><img src="/Air/img/main/best/best_img01.jpg" alt="" /></li>
					<li><img src="/Air/img/main/best/best_img02.jpg" alt="" /></li>
					<li><img src="/Air/img/main/best/best_img03.jpg" alt="" /></li>
					<li><img src="/Air/img/main/best/best_img04.jpg" alt="" /></li>
		...
		<div class="wrap">
			<div class="le essay">
				<h2>생생 여행 후기</h2>
				<div class="contents">
					<a href="#"><img src="/Air/img/main/essay/essay_img01.jpg" alt="" /></a>
					<a  href="#" class="txt_w">
						<em class="date">작성일 : 2015-10-28</em><em class="name">작성자 : 이종수</em><br />
						<span class="txt">2015.10.20 동유럽 + 발칸 9일 여행<br />정현 인솔자와 함께한 즐거운 여행사진</span>
					</a>
		...
		<div class="wrap">		
			<img src="/Air/img/main/banner_v1.jpg" alt="" />
		</div>
		<!-- //wrap -->
