...
<script src="../js/common.libs.js"></script>
<script src="../js/jquery.ListBox.js"></script>
<script src="../js/core.js"></script>
<script src="../js/opacity.slide.js"></script>
<script src="../js/hb.accordion.slide.js"></script>
	...
	<div class="wrapper">
		<div class="header">
			<div class="header-container">
				<h1>
					<a href="#"><img src="../img/main/logo.png" alt="MIRACLEAIR" /></a>
				</h1>
